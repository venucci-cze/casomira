...
void aktualizujRetezec(uint8_t data[7]) {
...
void zobrazCasy(int a, int b) {
  ...
  pole[0] = cisliceProCislo((a / 10) % 10);
  pole[1] = cisliceProCislo(a % 10);
  pole[2] = cisliceProCislo((b / 10) % 10);
  pole[3] = cisliceProCislo(b % 10);
